...
func RegisterFlags(flagSet *flag.FlagSet) {
	...
	flagSet.Bool("systrap-disable-fgt", false, "disables FEAT_FGT (Fine Grained Traps) in the Systrap platform on ARM64. Use if the host CPU does not support FEAT_FGT (e.g. Cortex-A57), which would cause stub creation to fail with SIGILL.")
